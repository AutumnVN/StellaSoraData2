...
CookieBoardCtrl._mapNodeConfig = {
	goBlur = {},
	ScoreBoardRhythm = {
		sCtrlName = "Game.UI.Play_Cookie_400004.CookieScoreBoardCtrl"
	},
	ScoreBoardOther = {
		sCtrlName = "Game.UI.Play_Cookie_400004.CookieScoreBoardCtrl"
	},
...
function CookieBoardCtrl:RefreshBoard()
	...
	for i = 1, nGridNum do
		...
		local currCtrl = self:BindCtrlByNode(goGrid, "Game.UI.Play_Cookie_400004.CookieGridCtrl")
...
local tbCookiePutinSound = {
	[4] = "mode_cookie2_putin_bell",
	[3] = "mode_cookie2_putin_snowman",
	[1] = "mode_cookie2_putin_sock",
	[2] = "mode_cookie2_putin_tree"
}
...
function CookieBoardCtrl:OnBtn_ConfirmGameOver()
	local closePanel = function()
		EventManager.Hit(EventId.ClosePanel, PanelId.CookieBoardPanel_400004)
	end
