...
JointDrillRankingCtrl._mapNodeConfig = {
	...
	rtSelfRank = {
		sCtrlName = "Game.UI.JointDrill.JointDrill_2.JointDrillRankItemCtrl"
	},
	btnReward = {
...
function JointDrillRankingCtrl:RefreshRankList()
	self.mapRankList = PlayerData.JointDrill_2:GetRankList()
...
function JointDrillRankingCtrl:RefreshRankGrid(goGrid, goGridIndex)
	...
	if self.tbRankGridCtrl[goGrid] == nil then
		local itemCtrl = self:BindCtrlByNode(goGrid, "Game.UI.JointDrill.JointDrill_2.JointDrillRankItemCtrl")
