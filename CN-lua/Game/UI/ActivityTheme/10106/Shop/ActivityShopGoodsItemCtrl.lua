...
function ActivityShopGoodsItemCtrl:RefreshInfo()
	...
	local sPath = "db_postal_shop_" .. AllEnum.FrameColor_New[mapItemCfg.Rarity]
	self:SetActivityAtlasSprite_New(self._mapNode.imgRare, "10106/SpriteAtlas/1010604", sPath)
