local ActivityPostal_10106PopUpCtrl = class("ActivityPostal_10106PopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivityPostal_10106PopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivityPostal_10106PopUpCtrl._mapEventConfig = {}
function ActivityPostal_10106PopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivityPostal_10106PopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivityPostal_10106PopUpCtrl:RefreshDate()
...
function ActivityPostal_10106PopUpCtrl:RefreshTimeout()
...
function ActivityPostal_10106PopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivityPostal_10106PopUpCtrl:OnBtnClick_Close()
...
function ActivityPostal_10106PopUpCtrl:OnBtnClick_Goto()
...
return ActivityPostal_10106PopUpCtrl
