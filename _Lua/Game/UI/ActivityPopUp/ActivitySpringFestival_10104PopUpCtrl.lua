local ActivitySpringFestival_10104PopUpCtrl = class("ActivitySpringFestival_10104PopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivitySpringFestival_10104PopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivitySpringFestival_10104PopUpCtrl._mapEventConfig = {}
function ActivitySpringFestival_10104PopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivitySpringFestival_10104PopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivitySpringFestival_10104PopUpCtrl:RefreshDate()
...
function ActivitySpringFestival_10104PopUpCtrl:RefreshTimeout()
...
function ActivitySpringFestival_10104PopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivitySpringFestival_10104PopUpCtrl:OnBtnClick_Close()
...
function ActivitySpringFestival_10104PopUpCtrl:OnBtnClick_Goto()
...
return ActivitySpringFestival_10104PopUpCtrl
