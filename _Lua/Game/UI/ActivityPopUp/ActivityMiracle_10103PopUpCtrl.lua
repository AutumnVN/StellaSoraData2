local ActivityMiracle_10103PopUpCtrl = class("ActivityMiracle_10103PopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivityMiracle_10103PopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivityMiracle_10103PopUpCtrl._mapEventConfig = {}
function ActivityMiracle_10103PopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivityMiracle_10103PopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivityMiracle_10103PopUpCtrl:RefreshDate()
...
function ActivityMiracle_10103PopUpCtrl:RefreshTimeout()
...
function ActivityMiracle_10103PopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivityMiracle_10103PopUpCtrl:OnBtnClick_Close()
...
function ActivityMiracle_10103PopUpCtrl:OnBtnClick_Goto()
...
return ActivityMiracle_10103PopUpCtrl
