local ActivityGunStorm_10109PopUpCtrl = class("ActivityGunStorm_10109PopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivityGunStorm_10109PopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivityGunStorm_10109PopUpCtrl._mapEventConfig = {}
function ActivityGunStorm_10109PopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivityGunStorm_10109PopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivityGunStorm_10109PopUpCtrl:RefreshDate()
...
function ActivityGunStorm_10109PopUpCtrl:RefreshTimeout()
...
function ActivityGunStorm_10109PopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivityGunStorm_10109PopUpCtrl:OnBtnClick_Close()
...
function ActivityGunStorm_10109PopUpCtrl:OnBtnClick_Goto()
...
return ActivityGunStorm_10109PopUpCtrl
