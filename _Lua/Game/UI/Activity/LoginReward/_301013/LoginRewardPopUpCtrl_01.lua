...
function LoginRewardPopUpCtrl_01:RefreshNPC2D()
	...
	self._mapNode.imgActor[1].gameObject:SetActive(nNpcId ~= 7133)
	self._mapNode.imgActor[2].gameObject:SetActive(nNpcId == 7133)
	if nNpcId == 7133 then
		self:SetActivityAtlasSprite(self._mapNode.imgActor[2], "_" .. self.nActId, sPath)
	else
