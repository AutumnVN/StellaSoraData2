...
local colorConditionsUnLock = Color(0.3254901960784314, 0.45098039215686275, 0.6862745098039216, 1)
...
ActivityLevelsSelectCtrl._mapNodeConfig = {
	...
	togRoot = {
		nCount = 8,
		sCtrlName = "Game.UI.ActivityTheme.10106.ActivityLevels.ActivityLevelsLvCtrl"
	},
	rt_Toggle = {},
...
function ActivityLevelsSelectCtrl:RefreshTogList(nType, nDifficulty)
	...
	if isEightLv then
		if self.isOpenLvMsg == false then
			NovaAPI.SetLayoutGroupPadding(self._mapNode.rt_Toggle, eightLvGroupPadding[1], eightLvGroupPadding[2], eightLvGroupPadding[3], eightLvGroupPadding[4])
		else
			NovaAPI.SetLayoutGroupPadding(self._mapNode.rt_Toggle, eightLvGroupPaddingOpen[1], eightLvGroupPaddingOpen[2], eightLvGroupPaddingOpen[3], eightLvGroupPaddingOpen[4])
		end
