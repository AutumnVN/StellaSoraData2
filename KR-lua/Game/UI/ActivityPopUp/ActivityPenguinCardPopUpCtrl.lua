local ActivityPenguinCardPopUpCtrl = class("ActivityPenguinCardPopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivityPenguinCardPopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivityPenguinCardPopUpCtrl._mapEventConfig = {}
function ActivityPenguinCardPopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivityPenguinCardPopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivityPenguinCardPopUpCtrl:RefreshDate()
...
function ActivityPenguinCardPopUpCtrl:RefreshTimeout()
...
function ActivityPenguinCardPopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivityPenguinCardPopUpCtrl:OnBtnClick_Close()
...
function ActivityPenguinCardPopUpCtrl:OnBtnClick_Goto()
...
return ActivityPenguinCardPopUpCtrl
