local RedDotDefine = {
	...
	TaskNewbie = "TaskNewbie",
	TaskNewbie_Tutorial = "TaskNewbie.Tutorial",
	TaskNewbie_TeamFormation = "TaskNewbie.TeamFormation",
	...
	Story_Set_Tab = "MainLine.StorySet.<param>",
	Story_Set_Chapter = "MainLine.StorySet.<param>.<param>",
	Story_Set_Section = "MainLine.StorySet.<param>.<param>.<param>",
	...
	Mall = "Mall",
	Mall_New = "Mall_New",
	Mall_Page = "Mall.Page.<param>",
	Mall_Page_New = "Mall_New.Page.New.<param>",
	Mall_Tab = "Mall.Page.<param>.Tab.<param>",
	Mall_Tab_New = "Mall_New.Page.New.<param>.Tab.New.<param>",
	Mall_Package = "Mall.Page.<param>.Tab.<param>.Package.<param>",
	Mall_Package_New = "Mall_New.Page.New.<param>.Tab.New.<param>.Package.New.<param>",
	Mall_Free = "Mall.Free",
	...
	Activity_GroupNew_Avg_Group = "Activity_Group_New.<param>.Activity_Group_Avg.<param>.<param>",
	Activity_PenguinCard_AllQuest = "Activity.PenguinCard.Quest",
	...
	ActivityLevel_Hard = "Activity_Group_New.<param>.ActivityLevel.Hard",
	ActivityLevel_Hard_Level = "Activity_Group_New.<param>.ActivityLevel.Hard.<param>",
