...
local Postal_10106Data = class("Postal_10106Data", ActivityGroupDataBase)
function Postal_10106Data:Init()
	self.tbAllActivity = {}
...
function Postal_10106Data:ParseActivity()
...
function Postal_10106Data:GetActivityDataByIndex(nIndex)
...
function Postal_10106Data:PlayCG()
	self:SendMsg_CG_READ(self.nCGActivityId)
end
function Postal_10106Data:GetActivityGroupCGPlayed()
	if self.bPlayedCG then
		return true
	end
	return PlayerData.Activity:IsCGPlayed(self.nCGActivityId)
end
function Postal_10106Data:IsActivityInActivityGroup(nActivityId)
	for _, activity in pairs(self.tbAllActivity) do
