...
function CookieGameCtrl:OnGridRefresh(go, nIndex)
	...
	local gridCtrl = self:BindCtrlByNode(go, "Game.UI.Play_Cookie_400004.CookieLevelGridCtrl")
...
function CookieGameCtrl:OnBtnClick_Enter()
	...
	local openPanel = function()
		EventManager.Hit(EventId.OpenPanel, PanelId.CookieBoardPanel_400004, self.nLevelId, bRhythmlMode, bPipeLineMode, levelData.CountDownLimit, self.nActId, nScoreNeedToPass or 0)
	end
