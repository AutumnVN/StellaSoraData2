local ActivityWinterNight_10105PopUpCtrl = class("ActivityWinterNight_10105PopUpCtrl", BaseCtrl)
local TimerManager = require("GameCore.Timer.TimerManager")
local LocalData = require("GameCore.Data.LocalData")
local ClientManager = CS.ClientManager.Instance
ActivityWinterNight_10105PopUpCtrl._mapNodeConfig = {
	goContent = {
		sNodeName = "---Common---"
	},
	btnGo = {
...
ActivityWinterNight_10105PopUpCtrl._mapEventConfig = {}
function ActivityWinterNight_10105PopUpCtrl:ShowPopUp(actId, callback, index)
...
function ActivityWinterNight_10105PopUpCtrl:PlayOpenAnim()
	if self.anim then
		self.anim:Play("open", 0, 0)
	end
end
function ActivityWinterNight_10105PopUpCtrl:RefreshDate()
...
function ActivityWinterNight_10105PopUpCtrl:RefreshTimeout()
...
function ActivityWinterNight_10105PopUpCtrl:OnBtnClick_DontShowAgain()
...
function ActivityWinterNight_10105PopUpCtrl:OnBtnClick_Close()
...
function ActivityWinterNight_10105PopUpCtrl:OnBtnClick_Goto()
...
return ActivityWinterNight_10105PopUpCtrl
